...
export interface ScPageContent {
  ...
  daily: {
    ...
    colAfter: string;
    colWhen: string;
    /** In working order; `when` is the moment relative to the session, never a weekday. */
...
const fr: ScPageContent = {
  ...
  hero: {
    ...
    board: {
      ...
      why: {
        ...
        apply: 'Appliquer',
        edit: 'Modifier',
        sources: 'Sources · GPS dernière séance · RPE · wellness · plan S12',
      },
    },
  },
  daily: {
    stamp: { a: 'AUTOUR DE LA SÉANCE', b: '9', c: 'tâches' },
    kicker: 'VOTRE QUOTIDIEN',
    title: 'Retrouvez vos neuf tâches de préparateur, exécutées par STRIVN.',
    ...
    rows: [
      {
        when: 'AVANT LA SÉANCE',
        before: 'Savoir qui est frais',
      ...
      },
      {
        ...
        before: 'Piloter la séance',
        after: 'Séance en direct : chrono par bloc, présences, blocs ajustés à la volée',
      },
      {
        when: 'AVANT LE MATCH',
        before: 'Dire au coach qui peut jouer',
  ...
  planning: {
    stamp: { a: 'SUR LA SEMAINE', b: '3 000 UA', c: 'Charge S12' },
  ...
  library: {
    stamp: { a: 'AVANT LA SÉANCE', b: '15 min', c: 'Bloc pressing' },
    ...
    visual: {
      ...
      totalTitle: 'Charge externe estimée · séance complète',
  ...
  strength: {
    stamp: { a: 'EN SALLE', b: '82 %', c: 'Bloc force' },
    tag: 'MUSCULATION & 1RM',
  ...
  tests: {
    stamp: { a: 'CAMPAGNE', b: '14 / 18', c: 'Saisies VMA' },
  ...
  reports: {
    stamp: { a: 'CHAQUE SEMAINE', b: 'S12', c: 'Rapport' },
...
const en: ScPageContent = {
  ...
  hero: {
    ...
    board: {
      ...
      why: {
        ...
        apply: 'Apply',
        edit: 'Edit',
        sources: 'Sources · last session GPS · RPE · wellness · plan W12',
      },
    },
  },
  daily: {
    stamp: { a: 'AROUND THE SESSION', b: '9', c: 'tasks' },
    kicker: 'YOUR WEEK',
    title: 'Find your nine S&C tasks, run by STRIVN.',
    ...
    rows: [
      ...
      },
      {
        ...
        before: 'Run the session',
        after: 'Live session: a clock per block, attendance, blocks adjusted on the fly',
      },
      {
        when: 'BEFORE THE MATCH',
        before: 'Tell the coach who can play',
  ...
  planning: {
    stamp: { a: 'ACROSS THE WEEK', b: '3,000 AU', c: 'Load W12' },
    tag: 'LOAD PLANNING',
  ...
  library: {
    stamp: { a: 'BEFORE THE SESSION', b: '15 min', c: 'Pressing block' },
    ...
    visual: {
      ...
      totalTitle: 'Estimated external load · full session',
      totalValue: '4,850 m · 21 sprints',
  ...
  strength: {
    stamp: { a: 'IN THE GYM', b: '82 %', c: 'Strength block' },
    tag: 'STRENGTH & 1RM',
  ...
  tests: {
    stamp: { a: 'CAMPAIGN', b: '14 / 18', c: 'MAS entries' },
  ...
  reports: {
    stamp: { a: 'EVERY WEEK', b: 'W12', c: 'Report' },
...
const nl: ScPageContent = {
  ...
  hero: {
    ...
    board: {
      ...
      why: {
        ...
        apply: 'Toepassen',
        edit: 'Aanpassen',
        sources: 'Bronnen · GPS laatste training · RPE · wellness · plan W12',
      },
    },
  },
  daily: {
    stamp: { a: 'ROND DE TRAINING', b: '9', c: 'taken' },
    kicker: 'UW WEEK',
    title: 'Vind uw negen taken als fysieke trainer terug in STRIVN.',
    ...
    rows: [
      {
        when: 'VOOR DE TRAINING',
        before: 'Weten wie fris is',
      ...
      {
        when: 'BIJ DE TERUGKEER',
        before: 'Terugkeer na blessure begeleiden',
        after: 'Medische opvolging: terugkeerprotocol, kinéslots, opbouwbelasting',
      },
      {
        when: 'TIJDENS DE TRAINING',
        before: 'De training aansturen',
        after: 'Live training: chrono per blok, aanwezigheid, blokken ter plekke aangepast',
      },
      {
        when: 'VOOR DE WEDSTRIJD',
        before: 'De coach zeggen wie kan spelen',
  ...
  planning: {
    stamp: { a: 'OVER DE WEEK', b: '3.000 AU', c: 'Belasting W12' },
  ...
  library: {
    stamp: { a: 'VOOR DE TRAINING', b: '15 min', c: 'Pressingblok' },
    ...
    visual: {
      ...
      totalTitle: 'Geschatte externe belasting · volledige training',
      totalValue: '4.850 m · 21 sprints',
  ...
  strength: {
    stamp: { a: 'IN DE GYM', b: '82 %', c: 'Krachtblok' },
  ...
  tests: {
    stamp: { a: 'CAMPAGNE', b: '14 / 18', c: 'MAS-invoer' },
  ...
  reports: {
    stamp: { a: 'ELKE WEEK', b: 'W12', c: 'Rapport' },
...
const de: ScPageContent = {
  ...
  hero: {
    ...
    board: {
      ...
      why: {
        ...
        score: 'Readiness 58',
        evidence: ['ACWR 7 / 28 T', 'Wochen über der Schwelle', 'Angegebener Schlaf', 'HSR letzte Einheit vs Profil', 'RPE letzte Einheit'],
        tag: 'Vorgeschlagen',
        proposal: 'Nächste Einheit: Volumen −30 %, kein Sprintblock.',
        apply: 'Übernehmen',
        edit: 'Ändern',
        sources: 'Quellen · GPS letzte Einheit · RPE · Wellness · Plan KW 12',
      },
    },
  },
  daily: {
    stamp: { a: 'RUND UM DIE EINHEIT', b: '9', c: 'Aufgaben' },
    kicker: 'IHRE WOCHE',
    title: 'Finden Sie Ihre neun Aufgaben als Athletiktrainer in STRIVN.',
    ...
    rows: [
      {
        when: 'VOR DER EINHEIT',
        before: 'Wissen, wer frisch ist',
        after: 'Readiness aus dem Wellness-Check-in berechnet: grün, orange, rot',
      },
      {
        when: 'NACH DER EINHEIT',
      ...
      {
        when: 'WÄHREND DER EINHEIT',
        before: 'Die Einheit steuern',
        after: 'Einheit live: Uhr pro Block, Anwesenheit, Blöcke spontan angepasst',
      },
      {
        when: 'VOR DEM SPIEL',
        before: 'Dem Cheftrainer sagen, wer spielen kann',
  ...
  planning: {
    stamp: { a: 'ÜBER DIE WOCHE', b: '3.000 AU', c: 'Belastung KW 12' },
  ...
  library: {
    stamp: { a: 'VOR DER EINHEIT', b: '15 min', c: 'Pressingblock' },
    ...
    visual: {
      ...
      totalTitle: 'Geschätzte externe Belastung · ganze Einheit',
      totalValue: '4.850 m · 21 Sprints',
  ...
  strength: {
    stamp: { a: 'IM KRAFTRAUM', b: '82 %', c: 'Kraftblock' },
  ...
  tests: {
    stamp: { a: 'KAMPAGNE', b: '14 / 18', c: 'MAS-Eingaben' },
  ...
  reports: {
    stamp: { a: 'JEDE WOCHE', b: 'KW 12', c: 'Bericht' },
...
const pt: ScPageContent = {
  ...
  hero: {
    ...
    board: {
      ...
      why: {
        ...
        apply: 'Aplicar',
        edit: 'Editar',
        sources: 'Fontes · GPS última sessão · RPE · wellness · plano S12',
      },
    },
  },
  daily: {
    stamp: { a: 'À VOLTA DA SESSÃO', b: '9', c: 'tarefas' },
    kicker: 'A SUA SEMANA',
    title: 'Encontre as suas nove tarefas de preparador no STRIVN.',
    ...
    rows: [
      ...
      {
        when: 'DURANTE A SESSÃO',
        before: 'Conduzir a sessão',
        after: 'Sessão em direto: cronómetro por bloco, presenças, blocos ajustados na hora',
      },
      {
        when: 'ANTES DO JOGO',
        before: 'Dizer ao treinador quem pode jogar',
  ...
  planning: {
    stamp: { a: 'AO LONGO DA SEMANA', b: '3 000 UA', c: 'Carga S12' },
  ...
  library: {
    stamp: { a: 'ANTES DA SESSÃO', b: '15 min', c: 'Bloco de pressing' },
    ...
    visual: {
      ...
      totalTitle: 'Carga externa estimada · sessão completa',
      totalValue: '4 850 m · 21 sprints',
  ...
  strength: {
    stamp: { a: 'NO GINÁSIO', b: '82 %', c: 'Bloco de força' },
    tag: 'MUSCULAÇÃO & 1RM',
  ...
  tests: {
    stamp: { a: 'CAMPANHA', b: '14 / 18', c: 'Registos VAM' },
  ...
  reports: {
    stamp: { a: 'CADA SEMANA', b: 'S12', c: 'Relatório' },
...
const es: ScPageContent = {
  ...
  hero: {
    ...
    board: {
      ...
      why: {
        ...
        apply: 'Aplicar',
        edit: 'Modificar',
        sources: 'Fuentes · GPS última sesión · RPE · wellness · plan S12',
      },
    },
  },
  daily: {
    stamp: { a: 'ALREDEDOR DE LA SESIÓN', b: '9', c: 'tareas' },
    kicker: 'SU SEMANA',
    title: 'Encuentre sus nueve tareas de preparador en STRIVN.',
    ...
    rows: [
      ...
      {
        when: 'DURANTE LA SESIÓN',
        before: 'Dirigir la sesión',
        after: 'Sesión en directo: cronómetro por bloque, asistencia, bloques ajustados sobre la marcha',
      },
      {
        when: 'ANTES DEL PARTIDO',
        before: 'Decir al entrenador quién puede jugar',
  ...
  planning: {
    stamp: { a: 'A LO LARGO DE LA SEMANA', b: '3.000 UA', c: 'Carga S12' },
  ...
  library: {
    stamp: { a: 'ANTES DE LA SESIÓN', b: '15 min', c: 'Bloque de pressing' },
    ...
    visual: {
      ...
      totalTitle: 'Carga externa estimada · sesión completa',
      totalValue: '4.850 m · 21 sprints',
  ...
  strength: {
    stamp: { a: 'EN EL GIMNASIO', b: '82 %', c: 'Bloque de fuerza' },
    tag: 'FUERZA & 1RM',
  ...
  tests: {
    stamp: { a: 'CAMPAÑA', b: '14 / 18', c: 'Registros VAM' },
  ...
  reports: {
    stamp: { a: 'CADA SEMANA', b: 'S12', c: 'Informe' },
    tag: 'INFORMES & PANEL',
