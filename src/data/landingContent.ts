...
export const landingContent: Record<Locale, LandingContent> = {
  fr: {
    ...
    capabilities: {
      ...
      items: [
        { title: 'Présences & RSVP', text: 'Les réponses des joueurs deviennent une vue coach à jour, sans recompter à la main.', href: '/fr/features/attendance/' },
  ...
  en: {
    ...
    capabilities: {
      ...
      items: [
        { title: 'Attendance & RSVP', text: 'Player replies become an up-to-date coach view, without counting by hand.', href: '/en/features/attendance/' },
  ...
  nl: {
    ...
    capabilities: {
      ...
      items: [
        { title: 'Aanwezigheid & RSVP', text: 'Antwoorden van spelers worden een up-to-date coachweergave, zonder handmatig te tellen.', href: '/nl/features/attendance/' },
  ...
  de: {
    ...
    capabilities: {
      ...
      items: [
        { title: 'Anwesenheit & RSVP', text: 'Antworten der Spieler werden zu einer aktuellen Coach-Ansicht, ohne von Hand zu zählen.', href: '/de/features/attendance/' },
  ...
  pt: {
    ...
    capabilities: {
      ...
      items: [
        { title: 'Presenças e confirmações', text: 'As respostas dos jogadores tornam-se uma visão atualizada para o treinador, sem contar à mão.', href: '/pt/features/attendance/' },
  ...
  es: {
    ...
    capabilities: {
      ...
      items: [
        { title: 'Asistencias y confirmaciones', text: 'Las respuestas de los jugadores se convierten en una vista al día para el entrenador, sin contar a mano.', href: '/es/features/attendance/' },
