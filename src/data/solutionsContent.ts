...
const fr: SolutionsContent = {
  ...
  compo: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'La proposition attend votre validation avant de s’appliquer. Le plan, l’app joueur et le rapport de la semaine reprennent ensuite la décision.',
        cta: 'Voir les rapports',
        tag: 'PROPOSÉ',
        proposal: 'L. Moreau · prochaine séance : volume −30 %, sans sprint.',
        apply: 'Appliquer',
        edit: 'Modifier',
        targets: 'Plan S12 · App joueur · Rapport S12',
      },
    ],
  },
  roles: {
  ...
  week: {
    title: 'Couvrez chaque séance, de l’import GPS au match.',
...
const en: SolutionsContent = {
  ...
  compo: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'The proposal waits for your approval before it applies. The plan, the player app and the weekly report then carry the decision.',
        cta: 'See reports',
        tag: 'PROPOSED',
        proposal: 'L. Moreau · next session: volume −30%, no sprints.',
        apply: 'Apply',
        edit: 'Edit',
        targets: 'W12 plan · Player app · W12 report',
      },
    ],
  },
  roles: {
  ...
  week: {
    title: 'Cover every session, from the GPS import to match day.',
...
const nl: SolutionsContent = {
  ...
  compo: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Het voorstel wacht op uw goedkeuring voordat het wordt toegepast. Het plan, de spelersapp en het weekrapport nemen de beslissing daarna over.',
        cta: 'Bekijk rapporten',
        tag: 'VOORGESTELD',
        proposal: 'L. Moreau · volgende training: volume −30 %, zonder sprints.',
        apply: 'Toepassen',
        edit: 'Wijzigen',
        targets: 'Plan W12 · Spelersapp · Rapport W12',
      },
    ],
  },
  roles: {
  ...
  week: {
    title: 'Dek elke training, van de GPS-import tot de wedstrijd.',
...
const de: SolutionsContent = {
  ...
  compo: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Der Vorschlag wartet auf Ihre Freigabe, bevor er greift. Plan, Spieler-App und der Wochenbericht übernehmen danach die Entscheidung.',
        cta: 'Berichte ansehen',
        tag: 'VORGESCHLAGEN',
        proposal: 'L. Moreau · nächste Einheit: Volumen −30 %, ohne Sprints.',
        apply: 'Anwenden',
        edit: 'Ändern',
        targets: 'Plan KW12 · Spieler-App · Bericht KW12',
      },
    ],
  },
  roles: {
  ...
  week: {
    title: 'Decken Sie jede Einheit ab, vom GPS-Import bis zum Spiel.',
...
const pt: SolutionsContent = {
  ...
  compo: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'A proposta espera a sua validação antes de se aplicar. O plano, a app do jogador e o relatório da semana retomam depois a decisão.',
        cta: 'Ver os relatórios',
        tag: 'PROPOSTO',
        proposal: 'L. Moreau · próxima sessão: volume −30 %, sem sprints.',
        apply: 'Aplicar',
        edit: 'Modificar',
        targets: 'Plano S12 · App do jogador · Relatório S12',
      },
    ],
  },
  roles: {
  ...
  week: {
    title: 'Cubra cada sessão, da importação GPS ao jogo.',
...
const es: SolutionsContent = {
  ...
  compo: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'La propuesta espera su validación antes de aplicarse. El plan, la app del jugador y el informe de la semana recogen después la decisión.',
        cta: 'Ver los informes',
        tag: 'PROPUESTO',
        proposal: 'L. Moreau · próxima sesión: volumen −30 %, sin sprints.',
        apply: 'Aplicar',
        edit: 'Modificar',
        targets: 'Plan S12 · App del jugador · Informe S12',
      },
    ],
  },
  roles: {
  ...
  week: {
    title: 'Cubra cada sesión, de la importación GPS al partido.',
