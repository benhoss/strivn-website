...
UPDATE load_categories SET name = 'Preparación física' WHERE team_id = 1 AND name = 'Prépa physique';
UPDATE load_categories SET name = 'Fútbol'             WHERE team_id = 1 AND name = 'Football';
UPDATE planned_weeks SET phase_label = 'Desarrollo' WHERE team_id = 1 AND phase_label = 'Développement';
...
UPDATE planned_slots ps SET label = t.es FROM (VALUES
  ...
  ('Muscu : bas du corps',        'Gimnasio: tren inferior'),
...
UPDATE calendar_events SET title = 'Reunión de staff' WHERE team_id = 1 AND title = 'Réunion staff';
