...
const URL = process.env.DECK_URL || 'http://localhost:4500/_muscu-carousel.html';
const OUT = resolve(DIR.website, 'launch-video/musculation-2026-08-09');
...
await browser.close();
console.log('DONE musculation carousel — ' + n + ' slides');
