...
const URL = process.env.DECK_URL || 'http://localhost:4500/_coach-carousel.html';
const OUT = resolve(DIR.website, 'launch-video/coach-app-2026-07-23');
...
await browser.close();
console.log('DONE coach carousel — ' + n + ' slides');
