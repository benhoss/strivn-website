...
const URL = process.env.DECK_URL || 'http://localhost:4500/_gps-carousel.html';
const OUT = resolve(DIR.website, 'launch-video/gps-module-2026-08-05');
...
await browser.close();
console.log('DONE gps carousel — ' + n + ' slides');
